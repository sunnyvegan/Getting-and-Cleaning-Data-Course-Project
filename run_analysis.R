...
Tidy_Data$activityID<-gsub(1, "WALKING",Tidy_Data$activityID)
Tidy_Data$activityID<-gsub(2, "WALKING_UPSTAIRS",Tidy_Data$activityID)
Tidy_Data$activityID<-gsub(3, "WALKING_DOWNSTAIRS",Tidy_Data$activityID)
Tidy_Data$activityID<-gsub(4, "SITTING",Tidy_Data$activityID)
Tidy_Data$activityID<-gsub(5, "STANDING",Tidy_Data$activityID)
Tidy_Data$activityID<-gsub(6, "LAYING",Tidy_Data$activityID)
